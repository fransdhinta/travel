...
<html lang="en">
<head>
<title>Lia Jaya Sentosa Tour & Travel</title>
...
<!--// bootstrap-css -->
<!-- css -->
<link rel="stylesheet" href="<?php echo base_url(); ?>assets1/css/style.css" type="text/css" media="all" />
<!--// css -->
<!-- font-awesome icons -->
...
<body>
	...
	<div class="banner">
		<!-- menu -->
			...
			<div id="m_nav_container" class="m_nav">
			  <ul id="m_nav_list" class="m_nav">
				...
				<li> <a href="<?php echo base_url(); ?>assets1/about.html">About</a> </li>
				<li> <a href="<?php echo base_url(); ?>assets1/gallery.html">Gallery</a> </li>
				<li> <a href="<?php echo base_url(); ?>assets1/blog.html">Blog</a> </li>
				<li> <a href="<?php echo base_url(); ?>assets1/icons.html">Icons</a> </li>
				<li> <a href="<?php echo base_url(); ?>assets1/codes.html">Codes</a> </li>
				<li> <a href="<?php echo base_url(); ?>assets1/contact.html">Contact</a> </li>
		...
		<div class="container">
			...
			<div class="w3l-banner-grids">
				<h1><a href="index.html">LIA JAYA TRAVEL</a></h1>
	...
	<script src="<?php echo base_url(); ?>assets1/js/jarallax.js"></script>
	<script src="<?php echo base_url(); ?>assets1/js/SmoothScroll.min.js"></script>
